...
def showbyplt(coco, img_prefix, img, classes, SelectedCats=None,fig=None):
    print(os.path.join(img_prefix,img['file_name']))
...
if __name__=="__main__":
    annFile = r'coco1/annotations/instances_val2017.json'
    img_prefix=r'coco1/images/val2017' #
    coco = COCO(annFile)
    # print(coco1)
    ...
    for img_id in coco.imgs:
        ...
        # showimg(coco1,img_prefix,img,SelectedCats)
        ...
        # showbyplt(coco1, img_prefix, img, coco_catid2name, SelectedCats,fig=fig)
